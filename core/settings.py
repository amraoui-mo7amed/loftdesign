...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="loftdesign"),
...
# WhiteNoise: Configure compression and caching for static files
STATICFILES_STORAGE = "whitenoise.storage.WhiteNoiseMiddleware"
